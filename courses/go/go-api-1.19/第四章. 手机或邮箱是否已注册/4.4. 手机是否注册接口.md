...
![手机是否注册接口](assets/13491-01.png)

创建 Auth 目录，Auth 目录下再创建 Signup 目录：

![手机是否注册接口](assets/13491-02.png)

### 1). 发送请求

创建请求：

![手机是否注册接口](assets/13491-03.png)
...
![手机是否注册接口](assets/13491-05.png)

### 3). 测试存在

再次发送请求，返回数据符合预期：

![手机是否注册接口](assets/13491-06.png)
