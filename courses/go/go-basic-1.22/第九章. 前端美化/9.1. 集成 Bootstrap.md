...
![集成 Bootstrap](assets/16524-01.png)

下载完成后解压，前往解压后的目录下，进入 dist 目录（distribution 的缩写），定位到下图两个文件：

![集成 Bootstrap](assets/16524-02.png)
...
![集成 Bootstrap](assets/16524-03.png)

查看下页面源码，访问 js 和 css 文件发现一切正常。

审查页面元素，查看响应标头：

![集成 Bootstrap](assets/16524-04.png)
...
![集成 Bootstrap](assets/16524-05.png)

样式标头正常，页面也能正常渲染。点击查看 articles 页面返回的标头：

![集成 Bootstrap](assets/16524-06.png)
...
![集成 Bootstrap](assets/16524-07.png)
