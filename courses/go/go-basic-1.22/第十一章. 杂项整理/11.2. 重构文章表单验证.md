...
![重构文章表单验证](assets/16542-01.png)

点击编辑按钮进入编辑页面，输入不合规的内容，点击更新按钮：

![重构文章表单验证](assets/16542-02.png)

输入合规的内容，点击更新：

![重构文章表单验证](assets/16542-03.png)

会出现 `500 服务器内部错误` 的报错。应该是我们的 SQL 出错了，此时打开命令行终端：

![重构文章表单验证](assets/16542-04.png)
...
![重构文章表单验证](assets/16542-06.png)

再次刷新 `500 服务器内部错误` 页面，并再次提交表单：

![重构文章表单验证](assets/16542-07.png)
