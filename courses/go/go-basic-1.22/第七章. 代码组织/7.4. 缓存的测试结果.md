...
![缓存的测试结果](assets/16509-03.png)

搜索关键词 `test flag` ，选择编辑 `settings.json` ：

![缓存的测试结果](assets/16509-04.png)
...
![缓存的测试结果](assets/16509-05.png)

再次运行测试，即可看到我们的 `-count=1` 了：

![缓存的测试结果](assets/16509-06.png)
