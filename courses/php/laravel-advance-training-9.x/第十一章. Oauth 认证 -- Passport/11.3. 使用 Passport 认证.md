...
![使用 Passport 认证](assets/12642-01.webp)

得到了正确的令牌信息，注意现在使用的用户是邮箱，我们是支持手机和邮箱两种登录方式的，现在尝试一下使用手机登录：

![使用 Passport 认证](assets/12642-02.webp)
...
![使用 Passport 认证](assets/12642-04.webp)
...
![使用 Passport 认证](assets/12642-05.webp)
...
![使用 Passport 认证](assets/12642-06.webp)

使用已经删除的 `access_token` 再次访问 `获取登录用户信息` 接口：

![使用 Passport 认证](assets/12642-07.webp)
