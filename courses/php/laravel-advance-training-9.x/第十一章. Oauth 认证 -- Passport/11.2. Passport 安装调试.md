...
![file](assets/12641-03.webp)

执行成功后，会在 `storage` 目录中看到两个以 `oauth` 开头的秘钥文件：

![file](assets/12641-04.webp)
