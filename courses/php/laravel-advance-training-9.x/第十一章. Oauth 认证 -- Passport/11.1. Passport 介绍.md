...
原文链接：https://learnku.com/courses/laravel-advance-training/9.x/passport-introduction/12640
...
但是对于我们自己的客户端，比如 Larabbs 的 IOS 客户端，中间的授权码流程就显得有些多余，这时 OAuth2 的另一个模式——[密码模式](https://learnku.com/docs/laravel/5.8/passport/3907#password-grant-tokens)，就很好的解决了这个问题。
