...
原文链接：https://learnku.com/courses/laravel-advance-training/9.x/install-larabbs/12588

## 安装 LaraBBS

[LaraBBS](https://github.com/summerblue/larabbs) 是在 [Laravel 教程 - Web 开发实战进阶 ( Laravel 9.x )](https://learnku.com/courses/laravel-intermediate-training/9.x) 中一步一步搭建的论坛系统，接下来我们基于这套论坛系统，完成 API 部分的训练。

>

学习过 [课程二](https://learnku.com/index.php/courses/laravel-intermediate-training/9.x) 的同学，如果你已经部署好了 LaraBBS的开发环境，可以跳过这一步。
...
如果你已经购买并完成了上一本教程，那么你的 github 上应该有一个自己的 larabbs 项目，比如 `[git@github.com](mailto:git@github.com):<username>/larabbs.git`，或者你可以 fork 一份，总之，你需要在 github 上有一个自己的 larabbs 项目，这样有助于你进行接下来的练习。

![file](assets/12588-01.webp)

假设你已经准备好了自己的 larabbs 的项目，注意请把下面的`<username>`替换为你的用户名。上一本教程的源码在 [github.com/summerblue/larabbs](https://github.com/summerblue/larabbs) 。
...
默认的分支是 `L02_8.x`，如果不是记得切换一下，使用 `git checkout L02_8.x`。
...
![file](assets/12588-02.webp)
中间省略掉安装细节…
![file](assets/12588-03.webp)
...
![file](assets/12588-04.webp)

## 创建新的分支

最后我们创建一个新的分支来完成接下来 API 功能。

```
$ git checkout -b L03_9.x
```

## 访问应用

现在让我们在 Chrome 浏览器中打开 [larabbs.test/topics](http://larabbs.test/topics) 你应该能看到有如下界面显示：

![file](assets/12588-05.webp)
