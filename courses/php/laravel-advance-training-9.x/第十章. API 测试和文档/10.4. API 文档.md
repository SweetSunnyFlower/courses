...
![file](assets/12638-02.png)

可以更加详细的描述响应数据。
![file](assets/12638-03.png)

支持 Markdown 格式的说明文件，我们可以为一组接口增加详细的调用说明。
![file](assets/12638-04.png)

另外 Apizza 还支持直接导入 PostMan 的 Collection 文件。
![file](assets/12638-05.png)

![file](assets/12638-06.png)

注意目前只支持 PostMan v1 版本的 Collection 文件。从 PostMan 导出一份 v1 版本的文件，导入 Apizza 中。
![file](assets/12638-07.png)

导出成功后即可看到文档已经同 PostMan 保持一致了。

![file](assets/12638-08.png)

当然还有团队协作以及文档分享功能。

![file](assets/12638-09.png)

![file](assets/12638-10.png)
