...
![file](assets/12637-01.png)

有多种导出格式可选，我们选择 PostMan 推荐的 `Collection v2.1`。
![file](assets/12637-02.png)
...
![file](assets/12637-03.png)

点击对应环境后面的下载即可。
![file](assets/12637-04.png)
...
![file](assets/12637-05.png)

在 `Manage Environments` 中点击 `Import` 即可导入环境变量。
![file](assets/12637-06.png)
