...
![file](assets/12603-01.webp)

登录后我们可以看到 `appId` 和 `appsecret`。

![file](assets/12603-02.webp)

我们需要关注自己的测试公众号，只有关注了测试公众号的用户，才可以进行授权操作，微信扫描 `测试号二维码` 即可。

![file](assets/12603-03.webp)

可以在右侧用户列表中看到已经关注的用户。

![file](assets/12603-04.webp)

在下面的 `体验接口权限表` 中我们可以找到 `网页授权获取用户基本信息`，点击最后的修改按钮

![file](assets/12603-05.webp)
...
![file](assets/12603-06.webp)

打开开发者工具，扫码登录，选择公众号项目
![file](assets/12603-07.webp)

打开后我们看到如下界面
![file](assets/12603-08.webp)
...
![file](assets/12603-09.webp)

点击确认登录
![file](assets/12603-10.webp)
