...
![短信提供商](assets/12596-01.png)

内容可以参照截图，个人用户`场景`只能选择`验证码`。

![短信提供商](assets/12596-02.png)

提交并等待签名审核通过。

![短信提供商](assets/12596-03.png)

### 添加模板

选择国内消息 》模板管理 》添加模板：

![短信提供商](assets/12596-04.png)
...
![短信提供商](assets/12596-06.png)

接下来我们到阿里云后台获取 API 的 Access Key：

![短信提供商](assets/12596-07.jpg)
...
![短信提供商](assets/12596-08.png)

还要给你的账户中充点值，阿里云的价格是 `0.047元/条` 所以充值几块钱够测试即可。

![短信提供商](assets/12596-09.png)
