...
![手机注册验证码](assets/12597-02.png)

再次执行 migrate，执行成功

![手机注册验证码](assets/12597-03.png)

## 2. 构建短信验证码接口

我们先将注册流程简化一下，将发送图片验证码的流程去掉，流程如下：

![file](assets/12597-04.png)
...
![手机注册验证码](assets/12597-07.png)

输入正确的手机号，可以正确发送短信。
![手机注册验证码](assets/12597-08.png)

记得将接口保存下来，方便下次调试，我们可以增加一个二级目录 `用户`，接口名称为 `发送短信验证码`。

![file](assets/12597-09.png)
