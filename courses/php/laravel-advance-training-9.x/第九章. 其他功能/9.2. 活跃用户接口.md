...
原文链接：https://learnku.com/courses/laravel-advance-training/9.x/active-user-interface/12631

## 活跃用户接口

Larabbs 的边栏会显示活跃用户，这一节我们会为这个功能开发接口：

![file](assets/12631-01.webp)

## 1. 生成测试数据

如果你的 Homestead 的 Cron 没有配置，你可能会发现，你本地的 Larabbs 并没有显示活跃用户

![file](assets/12631-02.webp)
...
由于算法计算的是 7 天内的用户发帖和评论数据，我们可以再填充一些帖子数据
...
![file](assets/12631-03.webp)

再次访问 larabbs.test，应该能看到活跃用户数据了

![file](assets/12631-04.webp)
