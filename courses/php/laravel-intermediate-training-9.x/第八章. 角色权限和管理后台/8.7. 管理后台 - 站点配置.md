...
原文链接：https://learnku.com/courses/laravel-intermediate-training/9.x/admin-settings/12532
...
config/administrator/settings/site.php
...
通过顶部导航栏进入站点设置页面，表单里填入以下内容：

![file](assets/12532-01.webp)

最后点击保存。且注意保存按钮下方没有报错信息。
