...
原文链接：https://learnku.com/courses/laravel-intermediate-training/9.x/admin-dashboard/12528
...
以上命令是安装所有 `9.` 主版本开头的 `summerblue/administrator` 包，如 `9.1`、`9.0.0`、`9.13.4`。
...
![file](assets/12528-01.webp)

点击打开的话会报错，我们将在下一节解决此问题。
