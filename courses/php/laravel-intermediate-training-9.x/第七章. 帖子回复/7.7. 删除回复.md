...
![file](assets/12524-01.png)

确定提交后会报错：

![删除回复](assets/12524-02.png)
...
![file](assets/12524-04.png)

第二种，寻找其他用户发布的帖子，发布一个评论，可以看到只能删除自己发表的评论：

![file](assets/12524-05.png)
...
![file](assets/12524-06.png)

1. 数据库里定位到此篇文章的评论：

![file](assets/12524-07.png)

1. 删除文章后刷新数据库：

![file](assets/12524-08.png)
