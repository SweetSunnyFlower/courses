...
原文链接：https://learnku.com/courses/laravel-intermediate-training/9.x/mail-notification/12523
...
首先我们需要在 QQ 邮箱的账号设置里开启 POP3 和 SMTP 服务。具体请查看 [如何打开POP3/SMTP/IMAP功能？](http://service.mail.qq.com/cgi-bin/help?subtype=1&id=28&no=166) 。

只需要开启以下：

![file](assets/12523-01.webp)

复制方框里的『授权码』，授权码将作为我们的密码使用：

![file](assets/12523-02.webp)
...
![file](assets/12523-03.webp)

登录除了 ID 为 1 的用户，并寻找 Summer 发布的话题进行回复提交：

![](assets/12523-04.webp)

提交成功后，刷新邮箱，一般几分钟内就能收到话题回复的邮件：

![file](assets/12523-05.webp)
