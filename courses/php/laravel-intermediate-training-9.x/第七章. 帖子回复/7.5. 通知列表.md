...
![file](assets/12522-02.png)

我们重新使用 Summer 用户登录，可看到显眼的红色标示，并且带有未读消息数量：

![file](assets/12522-03.png)

## 3. 控制器

如果你点击红色标示，会报错 —— 控制器文件并不存在：

![通知列表](assets/12522-04.png)
