...
原文链接：https://learnku.com/courses/laravel-intermediate-training/9.x/safety-problem/12512
...
Blade 的 `{!!  !!}` 语法是直接渲染数据，不会对数据做任何处理。在我们这种场景下，因为业务逻辑的特殊性，第二种方法不适用，我们将使用第一种方法，对用户提交的数据进行过滤来避免 XSS 攻击。
...
![file](assets/12512-01.webp)

提交表单后，渲染结果为安全的、被转义的内容：

![file](assets/12512-02.webp)
...
![file](assets/12512-03.gif)

直接就被注入了，使用数据库里的查看下提交的内容：

![file](assets/12512-04.gif)
...
![](assets/12512-06.webp)

打开新建话题页面，填入测试代码：

![file](assets/12512-07.webp)

点击提交，出现弹框表明我们已经被 XSS 注入，用户可以很轻易地在我们的网页上运行 JavaScript 脚本：

![file](assets/12512-08.webp)
