...
原文链接：https://learnku.com/courses/laravel-intermediate-training/9.x/auxiliary-function/12475

## 辅助函数

Laravel 提供了很多 [辅助函数](https://learnku.com/docs/laravel/8.x/helpers)，有时候我们也需要创建自己的辅助函数。
