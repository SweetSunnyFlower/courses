...
原文链接：https://learnku.com/courses/laravel-intermediate-training/9.x/create-application/12473
...
```bash
$ cd ~/Code
$ composer create-project laravel/laravel larabbs --prefer-dist "9.1.*"
```

![创建应用](assets/12473-01.webp)

中间省略掉安装细节…

![file](assets/12473-02.webp)
...
扩展阅读： 如何开启 NFS 支持，请查阅 —— [Wiki：Laravel Homestead：开启 NFS 解决站点响应缓慢](https://learnku.com/laravel/wikis/25550)
