...
![file](assets/12492-01.png)

## 模型文件修改

首先我们需在 `User` 模型里将 `avatar` 字段加入到允许修改的白名单 `$fillable` 中：

![上传头像](assets/12492-02.png)
...
![file](assets/12492-06.png)

提交成功，打开项目文件夹，一步步寻找下去，找到我们刚刚上传的图片：

![file](assets/12492-07.jpg)
