...
原文链接：https://learnku.com/courses/laravel-intermediate-training/9.x/avatar-croping/12495

## 裁剪图片

我们还有一个地方要优化，用户有时会上传分辨率较大的图片，类似以下：

![file](assets/12495-01.webp)
...
![file](assets/12495-03.webp)

>

注：此处我们使用默认的 `gd` 即可，如果你的项目需要较专业的图片处理，请考虑性能更佳的 ImageMagic。
...
![file](assets/12495-04.webp)

## 开始测试

进入 [资料编辑页面](http://larabbs.test/users/1/edit) ，选择一张较大的图片（[示例图片下载](https://cdn.learnku.com/uploads/images/201709/22/1/zzgDzs4TjD.png)），然后点击保存提交表单：

![file](assets/12495-05.webp)

可以看到更新成功的提示：

![file](assets/12495-06.webp)

打开文件夹查看我们刚刚上传的文件：

![file](assets/12495-07.webp)
