...
![file](assets/12481-01.png)

点击『注册』按钮提交表单，将会出现下图报错：

![用户注册](assets/12481-02.png)
...
![用户注册](assets/12481-04.png)

再往下滚动，还可以看到更加详细的信息：

![用户注册](assets/12481-05.png)
...
![file](assets/12481-10.png)

点击右上角 [登录](http://larabbs.test/login) 按钮，填写上一步注册时使用的邮箱和密码：

![file](assets/12481-11.png)

点击登录按钮进行登录：

![file](assets/12481-12.png)
