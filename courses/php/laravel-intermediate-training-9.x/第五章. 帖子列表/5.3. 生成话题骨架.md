...
原文链接：https://learnku.com/courses/laravel-intermediate-training/9.x/generate-topic/12500
...
- `unsigned()` —— 设置整数类型为非负整数(或称之为无符号整数)
...
此时打开 [larabbs.test/topics](http://larabbs.test/topics) ，查看话题列表页面：

![file](assets/12500-02.webp)

打开 [larabbs.test/topics/create](http://larabbs.test/topics/create) ，未登录用户会被要求登录，登录成功后会跳转到：

![file](assets/12500-03.webp)
