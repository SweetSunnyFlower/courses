...
原文链接：https://learnku.com/courses/laravel-intermediate-training/9.x/category-topics/12504
...
![file](assets/12504-01.webp)

并点击某个分类的链接进入分类列表页：

![file](assets/12504-02.webp)
...
![file](assets/12504-03.webp)

## 2. 列表页面标题定制

当我们在『分类话题列表』页面时，我们希望页面的标题里有当前的分类名称：

![file](assets/12504-04.webp)
...
使用 Composer 安装 [laravel active](https://github.com/summerblue-ext-forks/active)：
