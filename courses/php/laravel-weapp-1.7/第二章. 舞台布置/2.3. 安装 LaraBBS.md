...
原文链接：https://learnku.com/courses/laravel-weapp/1.7/install-larabbs/1431

本教程最新版为 [2.1](https://learnku.com/courses/laravel-weapp/2.1)，当前版本已放弃维护，请阅读最新版本！

## 安装 LaraBBS

[LaraBBS](https://github.com/summerblue/larabbs) 是在 [《Laravel 教程 - Web 开发实战进阶 ( Larave...](https://learnku.com/courses/laravel-intermediate-training/5.8) 中一步一步搭建的论坛系统，在[《Laravel 教程 - 实战构架 API 服务器》](https://learnku.com/courses/laravel-advance-training/5.8) 中我们一步步完成了 LaraBBS 的所有接口 ，接下来我们将基于这套接口，完成一个 LaraBBS 的微信小程序。

>

学习过 [《Laravel 教程 - 实战构架 API 服务器》](https://learnku.com/courses/laravel-advance-training/5.8) 的同学，如果你已经部署好了 LaraBBS 的开发环境，可以跳过这一步。
...
![file](assets/1431-01.webp)

中间省略掉安装细节...
![file](assets/1431-02.webp)
...
![file](assets/1431-03.webp)

## 访问应用

现在让我们在 Chrome 浏览器中打开 [larabbs.test](http://larabbs.test) 你应该能看到有如下界面显示：

![file](assets/1431-04.webp)
