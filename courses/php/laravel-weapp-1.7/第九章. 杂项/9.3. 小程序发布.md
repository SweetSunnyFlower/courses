...
![file](assets/1592-02.png)

我们还没有设置服务器域名，点击开始配置。

![file](assets/1592-03.png)
...
开发者工具的工具栏中有上传按钮。
![file](assets/1592-04.png)

输入版本号以及项目备注后即可上传到微信服务器了。
![file](assets/1592-05.png)

进入微信公众平台开发管理，可以在开发版本中看到刚才上传的代码了。
![file](assets/1592-06.png)

可以将当前版本设置为体验版本，这样就可以通过二维码分享给他人体验了。
![file](assets/1592-07.png)
![file](assets/1592-08.png)
...
![file](assets/1592-09.png)

2.

填写小程序的信息包括名称，头像，介绍：
![file](assets/1592-10.jpeg)

3.

填写完成后可以在 『设置』-> 『基本设置』 中看到填写的信息，可以再次修改，但是每个月有次数限制：
![file](assets/1592-11.png)

4.

上传了小程序，填写完小程序信息后，便可以进入 『开发管理』，将开发版本提交审核了：

![file](assets/1592-12.png)

5.

点击提交审核，勾选已阅读规则，点击下一步：
![file](assets/1592-13.png)

6.

添加一个功能页面，补充完整小程序相关的信息，如下图所示：
![file](assets/1592-14.png)

7.

提交审核成功：
![file](assets/1592-15.png)
