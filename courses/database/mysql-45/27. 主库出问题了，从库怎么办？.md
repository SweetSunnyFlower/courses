...
原文链接：https://jums.gitbook.io/mysql-shi-zhan-45-jiang/27-zhu-ku-chu-wen-ti-le-cong-ku-zen-mo-ban
![](assets/27-01.png)
...
2. 实例B把set\_b发给主库A’。
3. 实例A’算出set\_a与set\_b的差集，也就是所有存在于set\_a，但是不存在于set\_b的GITD的集合，判断A’本地是否包含了这个差集需要的所有binlog事务。\
