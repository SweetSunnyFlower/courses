# 第十章：Token 经济学：在 AI 能力与运行成本之间寻找平衡

原文链接：https://juejin.cn/book/7626976407423303731/section/7627371082638934025

![generated-image-1778414786997.png](assets/12-7627371082638934025-01.webp)
...
![generated-image-1778414792247.png](assets/12-7627371082638934025-02.webp)
...
![image.png](assets/12-7627371082638934025-03.webp)
...
![generated-image-1778414790085.png](assets/12-7627371082638934025-04.webp)
...
![image 1.png](assets/12-7627371082638934025-05.webp)
...
![generated-image-1778414793500.png](assets/12-7627371082638934025-06.webp)
...
![image 2.png](assets/12-7627371082638934025-07.webp)
...
async function expertAgentNode(state: typeof RequirementAnalysisState.State) {
  ...
  const compressed = await compressConversation(trimmed, summaryModel, {
    keepRecent: 10,
  });
...
![image 3.png](assets/12-7627371082638934025-08.webp)
...
![generated-image-1778414851016.png](assets/12-7627371082638934025-09.webp)
...
- cache_control：Anthropic 等厂商用于显式声明缓存断点的参数。
...
![image 4.png](assets/12-7627371082638934025-10.webp)
...
export function recordCacheResult(usage: {
  ...
  if (usage.cache_read_input_tokens && usage.cache_read_input_tokens > 0) {
    ...
    cacheStats.moneySaved +=
      (usage.cache_read_input_tokens / 1_000_000) * 3.0 * 0.9;
  } else {
...
![generated-image-1778414839172.png](assets/12-7627371082638934025-11.webp)
...
![image 5.png](assets/12-7627371082638934025-12.webp)
...
export function resolveModelForAgent(input: {
  ...
  if (budgetPercent >= 100) {
    ...
    return {
      selectedModelConfigId: defaultId,
...
![image 6.png](assets/12-7627371082638934025-13.webp)
...
在这组示例假设下，从约 ![600 到约 ](assets/12-7627371082638934025-14.svg)90，成本下降约 85%。真实比例取决于模型价格、缓存命中率、输出长度和实际调用次数。
...
- token_usages 表：本章新增的成本明细表，用来记录每次模型调用的 Token 与成本。
...
![image 7.png](assets/12-7627371082638934025-15.webp)
...
![image 8.png](assets/12-7627371082638934025-16.webp)
...
![generated-image-1778414839777.png](assets/12-7627371082638934025-17.webp)
...
![image 9.png](assets/12-7627371082638934025-18.webp)
