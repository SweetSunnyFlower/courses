# 第三章：LangChain 起手——搭建第一条服务端能力链路

原文链接：https://juejin.cn/book/7626976407423303731/section/7627369874558222382

![image.png](assets/05-7627369874558222382-01.webp)

本章分支[feat/first-chain](https://github.com/Cookieboty/autix-demo/tree/feat/first-chain)
...
![image.png](assets/05-7627369874558222382-02.webp)
...
![img.png](assets/05-7627369874558222382-03.webp)
...
![https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4694aa616f0d4bba91e4eed74349379f~tplv-k3u1fbpfcp-jj-mark](assets/05-7627369874558222382-04.webp)
配图仅为示例参考，具体内容以文章说明及实际代码为准。
...
![img.png](assets/05-7627369874558222382-05.webp)
...
[image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c7b19efa328c43e9b25ea202509d5281~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp#?w=1216&h=324&s=177196&e=png&b=fefefe)
配图仅为示例参考，具体内容以文章说明及实际代码为准。
...
![generated-image-1774765273638.png](assets/05-7627369874558222382-06.webp)
...
![image.png](assets/05-7627369874558222382-07.webp)
配图仅为示例参考，具体内容以文章说明及实际代码为准。
...
![image.png](assets/05-7627369874558222382-08.webp)
...
![image4.png](assets/05-7627369874558222382-09.webp)
配图仅为示例参考，具体内容以文章说明及实际代码为准。
...
![image.png](assets/05-7627369874558222382-10.webp)
...
![img.png](assets/05-7627369874558222382-11.webp)
配图仅为示例参考，具体内容以文章说明及实际代码为准。
...
> 说明：用例运行时，模型返回的字段措辞会随模型/温度波动（例如 `action` 可能是「用户注册」也可能是「绑定手机号」）。因此断言只校验结构化约定与关键语义命中，而不锁死具体字符串；这正是 `withStructuredOutput` 想保证的部分。
...
![image.png](assets/05-7627369874558222382-12.webp)
配图仅为示例参考，具体内容以文章说明及实际代码为准。
