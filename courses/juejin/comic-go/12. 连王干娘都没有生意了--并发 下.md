...
![](assets/12-6844733833489678343-01.png)
...
![](assets/12-6844733833489678343-02.png)
...
![](assets/12-6844733833489678343-03.png)
...
![](assets/12-6844733833489678343-04.png)
...
![](assets/12-6844733833489678343-05.png)
...
![](assets/12-6844733833489678343-06.png)

对于接收数据方，当没有数据可以接收的时候也会被阻塞。

![](assets/12-6844733833489678343-07.png)

## 创建缓冲通道

默认情况下无缓冲区的容量都是0，所以之前创建的通道都默认容量都是0。可以在声明通道之后一个参数来指定缓冲区的大小。

![](assets/12-6844733833489678343-08.png)
...
![](assets/12-6844733833489678343-09.jpg)

- `chan <- T  只写通道`

- `<- chan T  只读通道`

![](assets/12-6844733833489678343-10.png)
...
![](assets/12-6844733833489678343-11.jpg)
...
![](assets/12-6844733833489678343-12.jpg)
...
![](assets/12-6844733833489678343-13.jpg)

## select 语句实现通道的多路复用

![](assets/12-6844733833489678343-14.png)
...
![](assets/12-6844733833489678343-15.png)
...
![](assets/12-6844733833489678343-16.png)
