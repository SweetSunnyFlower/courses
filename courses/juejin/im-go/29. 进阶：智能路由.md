...
![chapter29.png](assets/29-6973502076793929765-01.png)

## 智能路由

智能路由本质上就是特殊的CLB。不过除了负载均衡功能之外，在长连系统中，还添加了更多规则逻辑，比如地理位置、业务规则等。

![client_loadbalance.png](assets/29-6973502076793929765-02.png)
...
![router_structure.png](assets/29-6973502076793929765-04.png)
...
![router_mapping_road.png](assets/29-6973502076793929765-05.png)
...
![image.png](assets/29-6973502076793929765-06.png)

### router服务

router服务就是一个接口服务，与royal类似。

![image.png](assets/29-6973502076793929765-07.png)
...
![hash_slots.png](assets/29-6973502076793929765-08.png)
...
![image.png](assets/29-6973502076793929765-09.png)
