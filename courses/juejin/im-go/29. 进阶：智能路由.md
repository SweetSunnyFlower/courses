...
原文链接：https://juejin.cn/book/6963277002044342311/section/6973502076793929765

![chapter29.png](assets/29-6973502076793929765-01.webp)

## 智能路由

智能路由本质上就是特殊的CLB。不过除了负载均衡功能之外，在长连系统中，还添加了更多规则逻辑，比如地理位置、业务规则等。

![client_loadbalance.png](assets/29-6973502076793929765-02.webp)
...
1. 网关定时把`当前并发p`、`总并发容量c`等信息通过Service中的Meta属性写到注册中心；路由服务在读取网关时，从中取出`负载`(![p/c](assets/29-6973502076793929765-03.svg)) 最低的N个网关。
...
![router_structure.png](assets/29-6973502076793929765-04.webp)
...
![router_mapping_road.png](assets/29-6973502076793929765-05.webp)
...
![image.png](assets/29-6973502076793929765-06.webp)

### router服务

router服务就是一个接口服务，与royal类似。

![image.png](assets/29-6973502076793929765-07.webp)
...
![hash_slots.png](assets/29-6973502076793929765-08.webp)
...
![image.png](assets/29-6973502076793929765-09.webp)
