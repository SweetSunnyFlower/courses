...
![chapter11.png](assets/11-6965876539825061919-01.png)

## 为什么要设计通信层?

在前面的架构设计中，系统被划分为了三个层级：SDK层、网关层、逻辑服务层。如此一来用户A发送给用户B一条消息，要经过四个长连通道，才能交付给另一个用户。如下图：

![消息流程.png](assets/11-6965876539825061919-02.png)
...
![通信层消息流程图.png](assets/11-6965876539825061919-03.png)
...
![server.png](assets/11-6965876539825061919-04.png)
...
![协议抽象.png](assets/11-6965876539825061919-05.png)
