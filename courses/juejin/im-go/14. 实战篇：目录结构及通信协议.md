...
![chapter11.png](assets/14-6985032325302059044-01.png)
...
![image.png](assets/14-6985032325302059044-02.png)

整个系统分为三大部分：`底层`、`业务层`、`测试用例`，我们通过下面这张图可以更容易理解它：

![KIM_directory.png](assets/14-6985032325302059044-03.png)
...
![系统分层_目录.png](assets/14-6985032325302059044-04.png)
...
![image.png](assets/14-6985032325302059044-05.png)
...
![image.png](assets/14-6985032325302059044-06.png)

#### 逻辑服务

逻辑服务与网关类似，不过在逻辑服务中，多了一些handler用于处理指令，与web系统中的controller类似。

![image.png](assets/14-6985032325302059044-07.png)

#### rpc服务

rpc服务就是Rest服务，本小册不会针对它做详细的讲解，但是会在具体的业务逻辑（比如离线消息）中涉及到到这部分的代码逻辑。

![image.png](assets/14-6985032325302059044-08.png)
...
![pkt_decode_encode.png](assets/14-6985032325302059044-09.png)
...
![协议定义.png](assets/14-6985032325302059044-10.png)
...
![会话分层.png](assets/14-6985032325302059044-11.png)
...
![全双工通信.png](assets/14-6985032325302059044-12.png)
...
![两种协议.png](assets/14-6985032325302059044-13.png)
...
![io_ReadFull.png](assets/14-6985032325302059044-14.png)
