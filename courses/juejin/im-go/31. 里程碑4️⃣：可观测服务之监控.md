...
![chapter31.png](assets/31-6973503048022753293-01.png)
...
![image.png](assets/31-6973503048022753293-02.png)
...
![observability_framework.png](assets/31-6973503048022753293-03.png)
...
![](assets/31-6973503048022753293-04.jpg)
...
![image.png](assets/31-6973503048022753293-07.png)
...
![gateway_metrics.png](assets/31-6973503048022753293-08.png)
...
![image.png](assets/31-6973503048022753293-09.png)
...
![image.png](assets/31-6973503048022753293-10.png)

在测试程序退出之后，再次访问/metrics接口，得到下图：

![image.png](assets/31-6973503048022753293-11.png)
...
![image.png](assets/31-6973503048022753293-12.png)

点击Graph菜单，就可以打开PromQL界面。在query框中输入kim_channel_total，执行之后就可以查询到这个metric的数据。如下图：

![image.png](assets/31-6973503048022753293-13.png)

此时没有数据，因此需要一点测试数据，因此再次使用到kimbench工具。经过一翻登录测试之后，得到如下图：

![image.png](assets/31-6973503048022753293-14.png)

同时，也可以看到内存分配情况。如下：

![image.png](assets/31-6973503048022753293-15.png)

同一时间段协程数量图。如下：

![image.png](assets/31-6973503048022753293-16.png)
