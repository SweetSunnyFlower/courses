...
![chapter13.png](assets/13-6973289235327483937-01.png)

## 里程碑

到这里，我们终于抵达了第一个`里程碑`。已经打了一个版本[Tag v1.1](https://github.com/klintcheng/kim/releases/tag/v1.1)：

![tagv1.1.png](assets/13-6973289235327483937-02.png)
...
![通信层架构.png](assets/13-6973289235327483937-03.png)
...
![tcp.png](assets/13-6973289235327483937-04.png)
