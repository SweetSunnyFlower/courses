...
![chapter21.png](assets/21-6982460601209454622-01.png)
...
![two_level_read.png](assets/21-6982460601209454622-02.png)
...
![user_msg_queue.png](assets/21-6982460601209454622-03.png)

如上所示，`离线队列`是以用户为单位，因此每个用户的离线队列中包括了`任何人发送过来的消息`，每个队列之间没有关系。同样的道理，在群聊中，消息要扩散投递给群中所有的成员，因此也可以把消息写到每个成员的群消息队列中。如下图：

![user_group_msg_queue.png](assets/21-6982460601209454622-04.png)
...
![user_msg_queue_2.png](assets/21-6982460601209454622-05.png)
...
![group_msg_queue_2.png](assets/21-6982460601209454622-06.png)
...
![GetOfflineMessageIndex.png](assets/21-6982460601209454622-07.png)
