...
![chapter26.png](assets/26-6973502679507189767-01.png)
...
![image.png](assets/26-6973502679507189767-02.png)
...
![image.png](assets/26-6973502679507189767-03.png)

选择View->Frame Graph，得到如下图：

![image.png](assets/26-6973502679507189767-04.png)

从左往右，分三个段，占用的cpu情况如下：

1. `http.(*conn).readRequest`: 解析http请求产生的耗时`0.19s`。

![image.png](assets/26-6973502679507189767-05.png)

1. `mock.(*ServerHandler).Accept`：登录认证逻辑产生的耗时`0.63s`。

![image.png](assets/26-6973502679507189767-06.png)

1. `ws.HTTPUpgrader.Upgrade`: 升级websocket产生的耗时`0.35s`。

![image.png](assets/26-6973502679507189767-07.png)
...
![image.png](assets/26-6973502679507189767-08.png)

选择`SAMPLE` -> inuse_space，如下：

![image.png](assets/26-6973502679507189767-09.png)

切换到inuse_space视角，如下图所示：

![image.png](assets/26-6973502679507189767-10.png)
...
![image.png](assets/26-6973502679507189767-11.png)
...
![image.png](assets/26-6973502679507189767-12.png)

第三段如下图，耗时为`0.31s`，优化前是`0.63s`。

![image.png](assets/26-6973502679507189767-13.png)

再次执行上面的allocs性能分析，优化后inuse_space存活对象占用空间图如下：

![image.png](assets/26-6973502679507189767-14.png)
...
![image.png](assets/26-6973502679507189767-15.png)
