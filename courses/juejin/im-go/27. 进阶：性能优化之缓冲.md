...
![chapter27.png](assets/27-6982223011004809231-01.png)
...
![image.png](assets/27-6982223011004809231-02.png)
...
![image.png](assets/27-6982223011004809231-03.png)
...
![image.png](assets/27-6982223011004809231-04.png)

耗时操作主要为读与写两步产生：

1. `writeloop` 这个goroutine中的异步消息写，耗时`1.21s`。

![image.png](assets/27-6982223011004809231-05.png)

1. `Readloop` 这个goroutine中的消息读取，耗时`1.21s`。

![image.png](assets/27-6982223011004809231-06.png)
...
![write_frame_buffer.png](assets/27-6982223011004809231-07.png)
...
![read_frame_buffer.png](assets/27-6982223011004809231-09.png)
...
![image.png](assets/27-6982223011004809231-10.png)

- 其中，ReadFrame的时间缩短为`0.77s`，优化之前是`1.21s`。

![image.png](assets/27-6982223011004809231-11.png)

- 其中，WriteFrame的时间缩短为`0.63s`，优化之前是`1.21s`。

![image.png](assets/27-6982223011004809231-12.png)
